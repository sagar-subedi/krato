...
func TestGossipJoin(t *testing.T) {
	...
	g1, _ := NewGossiper("N1", "127.0.0.1:17001", "127.0.0.1:17001", "127.0.0.1:19001", ch1, nil)
	g2, _ := NewGossiper("N2", "127.0.0.1:17002", "127.0.0.1:17002", "127.0.0.1:19002", ch2, nil)
...
func TestGossipFailureDetection(t *testing.T) {
	...
	g1, _ := NewGossiper("N1", "127.0.0.1:17003", "127.0.0.1:17003", "127.0.0.1:19003", ch1, nil)
	g2, _ := NewGossiper("N2", "127.0.0.1:17004", "127.0.0.1:17004", "127.0.0.1:19004", ch2, nil)
